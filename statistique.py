...
from utils.printer import print_new_line, print_yellow, print_blue
...
def descriptive_statistics(file_path, num_classes):
    ...
    print_yellow(f"---- Statistiques descriptives pour le fichier {file_path} ----")
...
def inferential_statistics(file_path1, file_path2, alpha, alpha1, alpha2, mu0):
    ...
    # Affichage des résultats
    print_yellow("---- Statistiques inférentielles ----")
...
def main():
    ...
    # Afficher les statistiques descriptives et les histogrammes
    descriptive_statistics("data/notesproba.txt", num_classes=10)
    
    print_new_line()
    
    descriptive_statistics("data/notestat.txt", num_classes=10)
    
    print_new_line()

    # Effectuer les tests statistiques
    inferential_statistics("data/notesproba.txt", "data/notestat.txt", alpha=0.05, alpha1=0.05, alpha2=0.05, mu0=10.5)
